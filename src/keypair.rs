...
impl Keypair {
    ...
    /// which is available with `use blake2::Blake2b` as in the example above.
    ...
    /// extern crate rand;
    ///
    /// use ed25519_dalek_blake2b::Digest;
    /// use ed25519_dalek_blake2b::Keypair;
    /// use ed25519_dalek_blake2b::Blake2b;
    /// use ed25519_dalek_blake2b::Signature;
    /// use rand::rngs::OsRng;
    ///
    /// # #[cfg(feature = "std")]
    ...
    /// let mut prehashed: Blake2b = Blake2b::new();
    ///
    ...
    /// let sig: Signature = keypair.sign_prehashed(prehashed, Some(context))?;
    ///
    /// // The sha2::Blake2b struct doesn't implement Copy, so we'll have to create a new one:
    /// let mut prehashed_again: Blake2b = Blake2b::default();
